...
impl Value {
    ...
    /// Returns the inner boolean, or an errors if not a boolean
    ...
    /// Returns the inner float, or an errors if not a float
    ...
    /// Returns the inner integer, or an errors if not an integer
    ...
    /// Returns the inner string, or an errors if not a string
